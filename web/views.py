...
class CrearContactoView(CreateView):
    ...
    template_name = 'web/contacto.html'  # Template para el formulario de creación
    success_url = reverse_lazy('contacto')  # URL a donde redirigir después de crear un contacto
 # URL a donde redirigir después de crear un contacto
"""
### VISTAS AUTH
...
"""VISTAS BASADAS EN CLASES CRUD CANCHAS LOGUEADO"""
"""CREA EL FORMULARIO Y LA VISTA SIMULTANEAMENTE"""
